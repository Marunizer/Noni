 ...
 */
//TODO Many unused variables, maybe delete
public class Camera {
	...
	private float currentRotationAngle; // Keeps us from going too far up or down.
...
//	}
	...
	private void RotateByMouse(float mousePosX, float mousePosY, float midX, float midY) {
