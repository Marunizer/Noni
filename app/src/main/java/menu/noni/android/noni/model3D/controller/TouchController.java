package menu.noni.android.noni.model3D.controller;
...
import menu.noni.android.noni.model3D.view.ModelRenderer;
import menu.noni.android.noni.model3D.view.ModelSurfaceView;
import menu.noni.android.noni.util.math.Math3DUtils;

//TODO: Many Variables/methods are never used. May be able to delete them if does not have unintended effect
...
public class TouchController {
	...
	public synchronized boolean onTouchEvent(MotionEvent motionEvent) {
		...
		if (touchDelay > 1) {
            //TODO: Added a flag check for rotating camera , Doesn't seem to work
			// INFO: Procesar gesto
